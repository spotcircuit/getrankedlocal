  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <h4 className="text-xl font-semibold text-center text-white mb-6">
          ...
          <Image
            ...
            width={640}
            height={640}
            className="rounded-xl shadow-2xl w-full max-w-[640px] mx-auto object-contain"
          />
        </motion.div>
